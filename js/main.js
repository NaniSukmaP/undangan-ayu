...
// const myAudio = new Audio("sounds/sounds.mp3");
//   function togglePlay() {
// 	return myAudio.paused ? myAudio.play() : myAudio.pause();
//   };
// document.querySelector(".malereang").addEventListener("click", function(){
// 	const myAudio = new Audio("sounds/sounds.mp3");
// 	myAudio.play();
//   });
// audioElement.play();
const myAudio = new Audio("sounds/sounds.mp3");
  $('.malereang').click(function() {
  ...
  function alamatCopy(){
	console.time('time1');
	  var temp = $("<input>");
	$("body").append(temp);
   temp.val($('#alamatHadiah').text()).select();
	document.execCommand("copy");
	temp.remove();
	  console.timeEnd('time1');
  }